abort "Please use Ruby 1.9 to build the Ember Data REST Adapter" if RUBY_VERSION !~ /^1\.9/
...
desc "Build ember-data-django-rest-adapter.js"
task :dist do
  puts "Building Ember Data REST Adapter..."
  pipeline.invoke
  puts "Done"
end
